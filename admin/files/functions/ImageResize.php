<?php
    ...
    class ImageResize {
        ...
        public function save($filename, $image_type = NULL, $quality = NULL, $permissions = NULL) {
            ...
            imagecopyresampled($dest_image, $this->source_image, $this->dest_x, $this->dest_y, $this->source_x,
                $this->source_y, $this->getDestWidth(), $this->getDestHeight(), $this->source_w, $this->source_h);
        ...
        /**
         * Resize image according to the given height (width proportional)
         *
        ...
        /**
         * Resize image according to the given width (height proportional)
         *
         * @param integer $width
         * @param boolean $allow_enlarge
         * @return \static
        ...
        /**
         * Resize image to best fit inside the given dimensions
         *
        ...
        /**
         * Resize image according to given scale (proportionally)
         *
        ...
        /**
         * Resize image according to the given width and height
         *
         * @param integer $width
         * @param integer $height
         * @param boolean $allow_enlarge
